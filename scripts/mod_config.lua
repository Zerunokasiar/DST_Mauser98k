...
PARAMS.BAYONET_HP_2 = GetModConfigData("mauser_bayonet_2_hp_value.2_1_2") or 200
PARAMS.BAYONET_HP_1 = GetModConfigData("mauser_bayonet_1_hp_value.2_1_2") or 100

PARAMS.RIFLE_R = "MAX_FIRE_DAMAGE_PER_SECOND"
PARAMS.RIFLE_M = "SPEAR_DAMAGE"
PARAMS.BAYONET_2 = "SPIKE_DAMAGE"
